...
export default function Dobavitelji() {
  ...
  const canEdit = hasPermission(profile, PERMISSIONS.EDIT_SUPPLIERS)
  ...
  return (
    <div style={{ display: "flex", minHeight: "100vh", fontFamily: "sans-serif" }}>
      <Sidebar active="/dobavitelji" profile={profile} />
            ...
            <tbody>
              {suppliers.length === 0 ? (
                ...
                <tr key={s.id} style={{ borderBottom: "1px solid #f3f4f6", background: i % 2 === 0 ? "white" : "#fafafa" }}>
                  ...
                  <td style={{ padding: "12px 16px", color: "#6b7280", fontSize: "13px", maxWidth: "200px" }}>{s.notes || "—"}</td>
                  {canEdit && (
