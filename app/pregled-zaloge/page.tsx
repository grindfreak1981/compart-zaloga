    ...
    <div style={{ display: "flex", minHeight: "100vh", fontFamily: "sans-serif" }}>
      ...
      <div style={{
        ...
        <div style={{ padding: "16px 12px", flex: 1 }}>
          {[
            { icon: "📊", label: "Pregled zaloge", active: true },
            { icon: "📥", label: "Prevzem blaga", active: false },
            { icon: "📤", label: "Poraba", active: false },
            { icon: "🏭", label: "Dobavitelji", active: false },
            { icon: "📋", label: "Naročila", active: false },
            { icon: "📈", label: "Poročila", active: false },
          ].map((item) => (
            <div
              key={item.label}
              style={{
                ...
                materials.map((material, i) => {
                  ...
                  return (
                    <tr key={material.id} style={{
                      background: status.bg !== "transparent" ? status.bg : (i % 2 === 0 ? "white" : "#fafafa"),
          ...
          >
            ...
            <div style={{ marginBottom: "16px" }}>
              ...
              <input
                ...
                placeholder="Npr. Tiskarski papir A4 80g"
                style={{
                  width: "100%",
                  padding: "10px 12px",
                  border: "1px solid #d1d5db",
            ...
            <div style={{ display: "flex", gap: "16px", marginBottom: "16px" }}>
              ...
              <div style={{ flex: 1 }}>
                ...
                <input
                  ...
                  onChange={e => setNewMaterial({ ...newMaterial, min_stock: parseInt(e.target.value) || 0 })}
                  style={{
                    width: "100%",
                    padding: "10px 12px",
                    border: "1px solid #d1d5db",
            ...
            <div style={{ marginBottom: "24px" }}>
              ...
              <textarea
                ...
                rows={3}
                placeholder="Dobavitelj, cena, opombe..."
                style={{
                  width: "100%",
                  padding: "10px 12px",
                  border: "1px solid #d1d5db",
            ...
            <div style={{ display: "flex", gap: "12px", justifyContent: "flex-end" }}>
              ...
              <button
                ...
                style={{
                  padding: "10px 20px",
                  background: newMaterial.name ? "#c41230" : "#9ca3af",
                  color: "white",
                  border: "none",
                  borderRadius: "6px",
                  cursor: newMaterial.name ? "pointer" : "not-allowed",
                  fontSize: "13px",
                  fontWeight: "bold",
                }}
              >
